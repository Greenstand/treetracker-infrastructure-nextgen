...
ansible localhost -m git -a "repo=git@github.com:Greenstand/treetracker-database.git dest=build/treetracker-data-pipeline version=$BRANCH force=yes depth=1" &
